...
module Cbrowse.Foundation where
...
import Cbrowse.App
import Cbrowse.Handlers

mkYesod "App" [parseRoutes|
    /source/+Texts SourceR GET
    /annotations/+Texts AnnotationsR GET
    / RootR GET
|]
...
instance Yesod App where
  ...
  shouldLogIO _ _ level = pure $ level >= LevelDebug
